...
from modules import main_ai, switch_assist, ship_prep, calendar_ics, profile, user_feedback
    ...
    if app_mode == "MAIN_AI":
        ...
        if st.button(reset_label, use_container_width=True):
            ...
            conversation_keys = [
                ...
                "feedback_comment",
                "feedback_submitted",
                "product_feedback_state",
                "_product_feedback_state_helpfulness",
                "_product_feedback_state_confusion",
                "_product_feedback_state_future_request",
...
# --------------------------------------------------
# Global feedback is available on every route, including the home page.
# --------------------------------------------------

user_feedback.render(current_lang, app_mode)
